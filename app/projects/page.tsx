  ...
  const projects = [
    {
      ...
      description:
        "A neural framework for developing self-aware digital entities with ethical constraints and emotional simulation.",
      tags: ["Quantum Neural Networks", "Consciousness Algorithms", "Ethical AI"],
      image: "/placeholder.svg?height=300&width=400",
      link: "/projects/consciousness-engine",
    },
    {
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-start justify-center space-y-4 mb-8 w-full relative z-10">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-xs tracking-widest text-foreground/60">SYNTHETIC INTELLIGENCE PROJECTS</span>
            </div>
